...
SELECT TAB.EMPRESA,
	   ...
	   SUM(TAB.REALIZADO_ORCAMENTO)									AS  'REALIZADO_ORCAMENTO'
FROM   (SELECT GCOLIGADA.CODCOLIGADA,
			   ...
			   TITMORCAMENTO.VALORREAL				 AS 'REALIZADO_ORCAMENTO'
        ...
        WHERE  1 = 1
					AND TITMORCAMENTO.IDPERIODO = 24
					AND TITMPERIODOORCAMENTO.IDITMPERIODO BETWEEN 1 AND 3
...
WHERE  TAB.CENTRODECUSTO LIKE '%IMPERATRIZ%' and TAB.NATUREZA  like '%agua%'
