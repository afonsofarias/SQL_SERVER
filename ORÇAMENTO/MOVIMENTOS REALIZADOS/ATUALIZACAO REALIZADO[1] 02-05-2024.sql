...
SELECT
		...
		AVG(TMOVORCAMENTO.VALOROPCIONAL2)							AS  'COMP_TMOVORCAMENTO',
	...
	HAVING AVG(TMOVORCAMENTO.VALOROPCIONAL2) > 0
),
VW_RELAC AS (
SELECT DISTINCT
	TMOV.CODCOLIGADA,
...
SELECT DISTINCT	
	...
	AVG(VW_ORCAMENTO.COMP_TMOVORCAMENTO) AS COMPROMETIDO,
