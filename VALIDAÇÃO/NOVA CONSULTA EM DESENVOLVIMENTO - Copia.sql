...
/*	VERIFICA VALORES NO PRODUTO DO ORÇAMENTO	*/
	SELECT 
		...
		--SUM(TITMMOV.RATEIOCCUSTODEPTO) AS TITMMOV_RATEIOCCUSTODEPTO,
...
VW_TAB AS (
	...
	SELECT 
		...
		END AS IDPERIODO,
		TMOV.CODCCUSTO,
		CASE WHEN TMOV.CODTMV LIKE '1.2%' THEN TITMMOV.RATEIOCCUSTODEPTO ELSE 0 END AS VALOR_REALIZADO 
	...
	WHERE
		...
		--AND TITMMOV.CODTBORCAMENTO = '2.7.01.001'
		--AND TMOV.CODCCUSTO = '01.04.02.01.02.006'
	GROUP BY
		...
		TMOV.CODCCUSTO,
		GCCUSTO.NOME,
		TITMMOV.RATEIOCCUSTODEPTO, --TITMMOV.VALORTOTALITEM,
		TMOV.VALORLIQUIDO,
		TMOV.IDMOV,
		TMOV.CODCOLIGADA,
		TMOV.CODFILIAL
	...
	WHERE
			1=1
		AND VW_TMOVORCAMENTO.IDORCAMENTO = 513273
		AND (
